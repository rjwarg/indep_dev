...
import akey
from gluon import *
ifxpw = akey.get_ifxpw()
mssqlpw = akey.get_mssqlpw()

## if NOT running on Google App Engine use SQLite or other DB
# db4 = DAL('mysql://rjwarg:ccpoa@mysql.server/rjwarg$indep',pool_size=1,check_reserved=['all'])
...
#   allowed_groups = ['TestGroup'],
   base_dn='dc=ccpoa,dc=org',
   group_dn = 'ou=ManagedObjects,dc=ccpoa,dc=org',
